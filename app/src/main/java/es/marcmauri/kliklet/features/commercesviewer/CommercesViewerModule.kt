...
import es.marcmauri.kliklet.features.commercesviewer.presenter.CommercesViewerDetailPresenter
...
class CommercesViewerModule {
    ...
    @Provides
    fun provideCommercesViewerDetailPresenter(): CommercesViewerDetailMVP.Presenter =
        CommercesViewerDetailPresenter()
